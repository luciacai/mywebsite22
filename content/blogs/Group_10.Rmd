---
title: "Analysis of Rent in San Francsisco"
author: "Group 10"
date: "`r Sys.Date()`"
output:
  html_document:
...
- ""
description: Project 1 # the title that will show up once someone gets to this page
draft: false
image: picc.jpeg # save picture in \static\img\blogs. Acceptable formats= jpg, jpeg, or png . Your iPhone pics wont work
...
What are the variable types? Do they all correspond to what they really are? Which variables have most missing values? \> Character and numeric. They all correspond to what they really are. Variable descr has the most missing values, of 197542 observations being NA.

```{r skim_data}
skimr::skim(rent)

#The variable types are primarily of numeric and character data type. The character variable 'descr' has the most missing values followed by the variables 'address', 'lon','lat',and 'details'. All categorical variables are of character type and  numeric variables (except date and year) correspond to numeric data type.
...
Finally, make a plot that shows median rental prices for the top 12 cities in the Bay area. Your final graph should look like this (colour = factor(beds))
